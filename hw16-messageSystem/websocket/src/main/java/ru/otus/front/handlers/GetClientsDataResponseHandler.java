...
public class GetClientsDataResponseHandler implements RequestHandler {
    private static final Logger logger = LoggerFactory.getLogger(GetClientsDataResponseHandler.class);
