...
abstract class ServiceCommandHandler extends BotCommand {

    protected static final Logger log = LoggerFactory.getLogger(ServiceCommandHandler.class);
    ...
    ServiceCommandHandler(Commands command) {
