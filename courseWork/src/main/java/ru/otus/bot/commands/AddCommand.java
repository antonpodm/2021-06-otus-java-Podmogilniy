...
public class AddCommand extends ServiceCommand{
    ...
    private static final String COMMAND_TEXT = "Товар добавлен. Для отображения списка Ваших товаров напишите боту " + CommandsList.LIST;
    private final CommandsHandler commandsHandler;

    public AddCommand(CommandsHandler commandsHandler) {
        super(CommandsList.ADD, CommandsList.ADD_DESCRIPTION);
        this.commandsHandler = commandsHandler;
    }

    public AddCommand(String identifier, String description, CommandsHandler commandsHandler) {
